...
%%% para los trabajos de Fin de Máster del Máster en
...
\begin{center}
    \begin{LARGE}
        Emparejamiento inteligente de titulaciones profesionales: una propuesta basada en Transformers optimizada para el español\\ [0.1em]
    \end{LARGE}
\end{center}
\vspace*{0.5cm}
\hrule
...
\vfill
\begin{center}
    \textbf{David García Curbelo} \\ [0.2em]
    Trabajo de investigación para el \\ \vspace{10pt}
    Máster en Tecnologías del Lenguaje\\ \vspace{10pt}
    Universidad Nacional de Educación a Distancia\\ \vspace{10pt}
    \vspace{2cm}
    Dirigido por la \\ \vspace{10pt}
    \textbf{Prof. Dra. D. Laura Plaza Morales} \\ [0.5em]
    % Febrero 2026\\
    \today\\
\end{center}
...
\noindent Dedicado a mi madre, por sembrar en mí la curiosidad que me mueve cada día a seguir avanzando. Gracias por enseñarme a apreciar la belleza del aprendizaje.
...
%%% ABSTRACT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{capitulos/0_Abstract.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% ENTRADAS A LOS FICHEROS CON LOS CAPÍTULOS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{capitulos/1_Introduccion}
\input{capitulos/2_EstadoArte}
\input{capitulos/3_Sistema}
\input{capitulos/4_Evaluacion}
\input{capitulos/5_Discusion}
\input{capitulos/6_Conclusiones}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% BIBLIOGRAFÍA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibliographystyle{config/config}
\cleardoublepage
...
\fancyhead[RE]{GLOSARIO}
\fancyhead[LO]{GLOSARIO}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% APÉNDICES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
\include{capitulos/Tablas}
