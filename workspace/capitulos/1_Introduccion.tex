...
\noindent Motivación del trabajo a realizar.\todo{Ejemplo de TO-DO: Hay que completar todo este parrafo y toda la seccion cuando tenga idea de lo que hay que hacer.}
...
En el documento lab-overview se tiene todo en relación a la construcción de los datos, el dataset, los benchmarks\dots
